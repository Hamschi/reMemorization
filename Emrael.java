    ...
    public void wald2Skript(Wald2 wald2) 
    {
        ...
        switch(phase)
        {
            ...
            case Wald2BeerenGegessen:
                int beruehrtBusch = getObjectsInRange(range, Busch.class).size();
                if((beruehrtBusch >0) && (Greenfoot.isKeyDown("space")))
                {
                    wald2.skriptWald2BeerenGegessen(this);
                }
                break;
