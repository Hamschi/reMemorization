...
public class Banditenteil extends Elshin
{
    ...
    private void prepare(ElshinZentrum ez)
    {
        ...
        addObject(new Mob(300, 1000, 80, 10, 1000, "Bandit_hl.png"), 252, 356);
        addObject(new Mob(300, 1000, 80, 10, 1000, "Bandit_vl.png"), 252, 44);
    }
    ...
    {
        addObject(new Mob(300, 1000, 80, 10, 1000, "Bradley_rege.png"), 339, 202);
    }
